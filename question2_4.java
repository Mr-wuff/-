...
public class question2_4 {
    ...
    public static void main(String[] args) {
         ...
         * number：当周购入的量（暂存器）
         */
        int ht,gt,count = 0,testcount=0,number = 0,lgt = 0,testnumber = 0;
        ...
        for (int t = 0; t < T+1; t++) {
            ...
            testnumber = number + number / 10 + 1;
            if (number % 10 == 0) testnumber--;
            testcount += testnumber;
            lgt = gt;
        }
        System.out.println("训练的操作手总量：" + testcount);//输出总购入数
